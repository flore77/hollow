...
public class HollowProducer {
    ...
    protected void runCycle(ListenerSupport.Listeners listeners, Populator task, Status.StageWithStateBuilder cycleStatus, long toVersion) {
        // 1. Begin a new cycle
     ...
     */
    protected void publish(ListenerSupport.Listeners listeners, long toVersion, Artifacts artifacts) throws IOException {
