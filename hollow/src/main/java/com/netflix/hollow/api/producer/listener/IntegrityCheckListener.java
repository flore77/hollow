...
public interface IntegrityCheckListener extends HollowProducerEventListener {
     ...
     *
     * @param status CycleStatus of the integrity check stage. {@link Status.StageWithState#getType()} will return {@code SUCCESS}
     ...
     */
    void onIntegrityCheckComplete(Status.StageWithState status, Duration elapsed);
}
